...
?>
<h2>Unread Messages</h2><p />
<?php
$grab_messages = mysql_query("SELECT * FROM messages WHERE user_to='$username' && opened='no' && deleted='no'");
...
<div class="alert alert-info">
    <strong>Info!  </strong> You haven't read any messages yet.
  </div>
<?php
}
?>
<h2>Read Messages:</h2><p />
<?php
$grab_messages = mysql_query("SELECT * FROM messages WHERE user_to='$username' && opened='yes' && deleted='no'");
